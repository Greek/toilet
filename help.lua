...
Configuration:
  ...
  4. ,filter add delete <phrase> -- Add a phrase to automagically delete (!!! no sentences !!!)
  5. ,filter add ban <phrase> -- Add a phrase to automagically ban a user for (!!! no sentences !!!)
  6. ,filter remove <phrase> -- Remove a phrase from the filter.
  7. ,filter reset -- Reset the whole filter.
